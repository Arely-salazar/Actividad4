...
public class Actividad4 {
    ...
    public static void escoger(int numEscogido){
        ...
        switch(numEscogido){
            case 1:
                ...
                System.out.println("Seleccionaste Clave Morse");
            ...
            case 2:
                ...
                System.out.println("Seleccionaste Star Wars");
               
                System.out.println();
                
                System.out.println("Introduce un genero ya sea: ");
            ...
            case 3:
                ...
                System.out.println("Seleccionaste Quizz");
                System.out.println();
                preguntasQuizz();
                incisosQuizz(); 
                recorrido();
 ...
 //codigo
    ...
    public static String Pago(String frase, char carFrase[]){
        ...
        if(cont <= 5){
            ...
            precio = ((cont - 5) * 3) + 10;}
        return "Número total de palabras: " + cont + "\n" + "Son $" + precio + " pesos";
    }
